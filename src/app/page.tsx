      ...
      <div className="relative pt-28 ml-auto">
        <div className="lg:w-2/3 text-center mx-auto">
          <h1 className="text-gray-900 text-balance dark:text-white font-bold text-5xl md:text-6xl xl:text-7xl">
            ...
            <span className="text-tertiary dark:text-white">Segurança.</span>
          </h1>
          <p className="mt-8 text-lg text-gray-700 dark:text-gray-300">
            No cenário digital de hoje, autenticação não é apenas uma barreira —
            é a base da confiança. O Auth Guard oferece um sistema robusto,
            inteligente e adaptável, garantindo proteção sem comprometer a
          ...
          <div className="hidden gap-16 py-8 mt-16 border-y border-gray-100 dark:border-gray-800 sm:flex justify-between">
            <div className="text-left">
              ...
              <p className="mt-2 text-lg text-gray-500">
                Autenticação fluida e segura, garantindo acesso confiável sem
            ...
            <div className="text-left">
              ...
              <p className="mt-2 text-gray-500">
                Integração ágil e escalável, pronta para evoluir com as
            ...
            <div className="text-left">
              ...
              <p className="mt-2 text-gray-500">
                Criptografia avançada, conformidade rigorosa e defesa contínua
